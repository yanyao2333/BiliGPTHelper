...
class SummarizeChain:
    ...
    def __init__(
            ...
            whisper_model_obj,
            whisper_obj,
            video_status_recorder: TaskStatusRecorder,
    ):
        ...
        self.video_status_recorder = video_status_recorder
    ...
    async def _check_require(self, at_items: AtItems, _uuid: str) -> bool:
        ...
        if (
            ...
            self.video_status_recorder.update_record(_uuid, stage=TaskProcessStage.END,
    ...
    async def _get_subtitle_by_whisper(self, video_info, video: BiliVideo, _uuid: str, format_video_name,
        ...
        if len(video_info["subtitle"]["list"]) == 0:
            ...
            text = self.whisper_obj.whisper_audio(
            ...
            self.video_status_recorder.update_record(_uuid, data=temp, use_whisper=True)
    ...
    async def _send_reply(self, at_items: AtItems, resp: dict, video_info: dict, _uuid: str):
        ...
        self.video_status_recorder.update_record(_uuid, stage=TaskProcessStage.WAITING_PUSH_TO_CACHE)
    ...
    async def start_chain(self):
        try:
            while True:
                ...
                _item_uuid = self.video_status_recorder.create_record(at_items, TaskProcessStage.PREPROCESS,
                ...
                self.video_status_recorder.update_record(_item_uuid, stage=TaskProcessStage.WAITING_LLM_RESPONSE)
                ...
                self.video_status_recorder.update_record(_item_uuid, stage=TaskProcessStage.WAITING_SEND)
                ...
                if answer:
                    try:
                        ...
                        if resp["noneed"] is True:
                            ...
                            self.video_status_recorder.update_record(_item_uuid, stage=TaskProcessStage.END,
                        ...
                        self.video_status_recorder.update_record(_item_uuid, stage=TaskProcessStage.WAITING_RETRY)
